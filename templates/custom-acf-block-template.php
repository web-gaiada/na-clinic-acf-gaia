                                    ...
                                    <div class="flex gap-y-8 flex-col lg:flex-row lg:justify-between justify-center pb-8">
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="address-wrapper menu mb-8 text-white">
                                                <a href="#" class="text-base text-white">Jl. Raya Puputan No.122, Sumerta Kelod,<br />Kec. Denpasar Timur, Kota Denpasar, Bali 80234</a>
                                            </div>
                                            <div class="address-wrapper menu text-white">
                                                <a href="#" class="text-base text-white">Jl. Danau Toba No.15, Sanur, Denpasar Selatan,<br />Kota Denpasar, Bali 80228</a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="flex gap-x-16 flex-wrap md:flex-nowrap">
                                                <div class="contacts-wrapper">
                                                    ...
                                                    <div class="menu-wrapper flex gap-x-6">
                                                        <div class="menu mb-4">
                                                            <a href="#" class="w-[24px] h-[24px] justify-center items-center flex no-anim" style="--fill: #FFFBF3; scale: 1.4;">
                                                ...
                                                <div class="link-wrapper">
                                                    ...
                                                    <div class="menu-wrapper">
                                                        ...
                                                        <div class="menu mb-4">
                                                            <a href="#" class="text-base text-theme-ivory">Treatment</a>
                                                        </div>
                                                        <div class="menu mb-4">
                                                            <a href="#" class="text-base text-theme-ivory">Promotions</a>
                                                        </div>
                                                        <div class="menu mb-4">
                                                            <a href="#" class="text-base text-theme-ivory">About Us</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="contacts-wrapper">
                                                    ...
                                                    <div class="menu-wrapper">
                                                        <div class="menu mb-4">
                                                            <a href="#" class="text-base text-theme-ivory">Plan a Visit</a>
                                                        </div>
                                                        <div class="menu mb-4">
                                                            <a href="#" class="text-base text-theme-ivory">Email Us</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
